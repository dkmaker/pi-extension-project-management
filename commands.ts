      ...
      pi.sendMessage(
        {
          ...
          content: [
            ...
            `2. Ask the user: *"What problem or situation prompted this idea?"* — include their answer as motivation context in the description`,
            `3. Propose a concrete idea: short **title** + **description** (2-4 sentences including the motivation/why, markdown)`,
            `4. Present for approval — do NOT create until the user approves`,
            `5. On approval, call \`issue_add\` with type \`idea\``,
          ].join("\n"),
          display: false,
        },
        { triggerTurn: true, deliverAs: "steer" },
      ...
      pi.sendMessage(
        {
          ...
          content: [
            ...
            `**Your task:**`,
            `1. Consider project context (epics, issues, assets, current state)`,
            `2. Ask the user: *"What problem or situation prompted this feature request?"* — include their answer as motivation context in the description`,
            `3. Propose: short **title**, **description** (what problem it solves including the motivation/why, 2-3 sentences), and **implementation approach** (key changes, files affected)`,
            `4. Present for approval — do NOT create until the user approves`,
            `5. On approval, call \`issue_add\` with type \`feature\``,
          ].join("\n"),
          display: false,
        },
        { triggerTurn: true, deliverAs: "steer" },
